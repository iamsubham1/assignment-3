                    ...
                    <div className="profile-section mb- flex items-start ">
                        <div className="avatar-container relative mr-4 flex justify-between items-center gap-5">
                            <div className=''>
                                ...
                                <div className="sm:h-44 sm:w-44 rounded-full border-4 border-dotted border-gray-400 flex items-center justify-center text-gray-400">
                                    {avatar ? (
                            ...
                            <div className='flex flex-col  items-start' >
                                ...
                                <input type="file" id="avatar" accept="image/*" className="hidden" ref={inputRef} />
